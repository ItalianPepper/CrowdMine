...
$idUtente = "1";
if (isset($_SESSION["annunciReclamati"]) & isset($_SESSION["listaUtentiAssociati"])) {
    $annunci = unserialize($_SESSION["annunciReclamati"]);
    $listaUtentiAssociati = unserialize($_SESSION["listaUtentiAssociati"]);
    unset($_SESSION["listaUtentiAssociati"]);
    unset($_SESSION["annunciReclamati"]);
} else {
    header("Location: " . DOMINIO_SITO . "/annunciReclamati");
}
                ...
                <div class="card">
                    ...
                    <div class="row col-md-12 col-sm-12 col-xs-12 media-categories"
                        ...
                        <div class="media-action">
                            <button class="btn btn-link" data-toggle="modal" data-target="#myModal2"><i
                                    class="fa fa-check" style="font-size: 200%;"></i> Attiva
                            </button>
                            <button class="btn btn-link" data-toggle="modal" data-target="#myModal3"><i
                                    class="fa fa-close" style="font-size: 200%;"></i> Disattiva
                            </button>
                            <?php if ($user->getRuolo() == "moderatore") { ?>
                                <button class="btn btn-link" data-toggle="modal" data-target="#myModal4"><i
                                        class="fa fa-check-circle" style="font-size: 200%;"></i> Invia
                                    all'amministratore
                                </button>
                            <?php } ?>
