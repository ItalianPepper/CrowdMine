...
$idUtente="1";
if (isset($_SESSION["annunciConflitto"])){
    $annunci = unserialize($_SESSION["annunciConflitto"]);
    unset($_SESSION["annunciConflitto"]);
} else {
    header("Location: " . DOMINIO_SITO . "/annunciConflitto");
}
...
<div class="app app-default">
    ...
    <?php include_once "asidePannelloAmministratore.php"?>
