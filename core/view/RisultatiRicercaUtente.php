...
<?php
if (isset($_SESSION["listResultFindUser"])){
    $listaUtenti =  unserialize($_SESSION["listResultFindUser"]);
    unset($_SESSION["listResultFindUser"]);
}else{
                    ...
                    <div class="card-body app-heading">
                        <div class="app-title">
                            <div class="title"><span
                                    class="highlight">Risultati Ricerca</span></div>
                        </div>
                    </div>
                </div>
            </div>
                                ...
                                <div class="col-lg-12 col-md-12 col-xs-12">
                                    <div class="media social-post">
                                        <div class="media-left">
                                            <a href="#">
                                                <img src="<?php echo $user->getImmagineProfilo(); ?>"/>
                                            </a>
                                        </div>
                                        <div class="section">
