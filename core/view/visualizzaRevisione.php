...
$idUtente="1";
if (isset($_SESSION["annunciRevisione"]) && isset($_SESSION["listaUtentiAssociati"])){
    $annunci = unserialize($_SESSION["annunciRevisione"]);
    $listaUtentiAssociati =unserialize($_SESSION["listaUtentiAssociati"]);
    unset($_SESSION["annunciRevisione"]);
    unset($_SESSION["listaUtentiAssociati"]);
} else {
    header("Location: " . DOMINIO_SITO . "/annunciRevisione");
}
                    ...
                    <div class="card-body app-heading">
                        <div class="app-title">
                            <div class="title"><span
                                    class="highlight">Annunci Revisione</span></div>
                        </div>
                    </div>
                </div>
            </div>
