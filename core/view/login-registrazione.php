    ...
    <div class="card col-md-10">
        <form method="post" action="javascript:submitForm()" id="modulo" name="modulo">
            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="form-group has-feedback">
                        <div class="input-group date" id="data-pick">
                    ...
                    <div class="form-group has-feedback">
                        <div class="input-group">
                            <select class="form-control select2" name="citta" id="listacitta" style="width: 100%;" >
                                <option selected disabled>Seleziona una citt&agrave;</option>
                            </select>
                            <div class="input-group-addon">
            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="form-group has-feedback">
                        ...
                        <div class="input-group">
                            <input type="password" class="form-control" name="passwordretyped" placeholder="Conferma password*" required>
                            <div class="input-group-addon">
                                <i class="fa fa-lock"></i>
                            </div>
                        </div>
...
<script>
    ...
    $('#data-pick').datepicker({ format: 'yyyy-mm-dd' });
